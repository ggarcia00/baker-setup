 ...
 * @version      4.0.0
 * @revision     $Id: HU.php 256 2019-03-17 19:30:13Z Luisehahne $
...
$TEXT['WBMAILER_DEFAULT_SETTINGS_NOTICE'] = 'Kérlek add meg az alapértelmezett "Küldàemail" címet és a "Küldàszemély" mez-?-?. Ajánlott az alábbi fosználata: <strong>admin@tedomained.hu</strong>. Némely szolgáltató (e.g. <em>mail.com</em>) Visszautasíthatja a leveleket az olyan küldàcímt-?-? mint <@mail.com</em> ez azért van hogy megakadályozzák a SPAM küldést.<br /><br />Az alapértelmezett értékek csak akkor érvényesek,ha nincs más megadva aker-ben. Ha a szervered támogatja <abbr title="Simple mail transfer protocol">SMTP</abbr>protokolt, akkor használhatod ezt az opciót levél küldéhez.';
$TEXT['WBMAILER_FUNCTION'] = 'Mail Rutin';
$TEXT['WBMAILER_NOTICE'] = '<strong>SMTP Mailer Beállítások:</strong><br />Ezek a beállítások csak akkor szükségesek, ha emailt akarsz küldeni <acro="Simple mail transfer protocol">SMTP</abbr> protokollon keresztül. Ha nem tudod az SMTP kiszolgálódat, vagy nem vagy biztos a követleményekben, akkoszer-?-ÃÂ¦en maradj az alap beállításnál: PHP MAIL.';
