CKEDITOR.dialog.add( 'syntaxhighlightDialog', function( editor ) {
    var getDefaultOptions=function() {
        ...
        var validLangs=['cpp','c','c#','css','delphi','pascal','pas','diff','java','jfx','javafx','js','jscript','javascript','perl','Perl','pl','php','text','plain','powershell','ps','py','python','ruby','rails','sass','scss','sql','typescript','vb','xml','xhtml','xslt','html'];
