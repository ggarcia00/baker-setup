            ...
            def.addContents( {
                ...
                elements: [
                    ...
                    html: '<style type="text/css">' +
                        ...
                        '}' +
                        '</style>' +
                        '<div class="cke_about_container" style="width:445px !important;">' +
                        '<div class="cke_wbabout_logo"></div>' +'<br/>' +
                        '<p>' +
                            lang.wbModuleinfo.replace( '$1', editor.config.WBversion) + editor.config.WBrevision +') ' +
                        '<br/>' +
                        '' +
                            lang.wbMoreInfo.replace( '$1', '<a href="https://websitebaker.org/">' + lang.wbUserGuide + '</a>' ) +
                        '</p>' +
                        '<p>' +
//                            lang.wbHelp.replace( '$1', '<a href="https://websitebaker.org/">' + lang.wbUserGuide + '</a>' ) +
//                        '<br/>' +
                        '' +
                            lang.wbModulversion.replace( '$1', editor.config.ModulVersion) + editor.config.ModulVersion +' ' +
                        '</p>' +
                        '<p>' +
                            lang.wbCopy.replace( '$1', '<a href="https://websitebaker.org/">WebsiteBaker Org e.V.</a> - WebsiteBaker Project' ) +
                        '</p>' +
                        '</div>'
                }
                ]
