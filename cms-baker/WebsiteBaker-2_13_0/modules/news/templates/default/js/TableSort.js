...
/*
        ...
        var js = document.getElementById("drag");
        var warn = document.getElementById("frm-warning");
        var btn  = document.getElementById("frm-btn");
            js.className   = "jsadmin";
            warn.className = "hide";
            btn.className  = "hide";
