...
class SessionGarbage {
    ...
    private const INTERVAL = 84400; // seconds between executes (default: once a day= 84400)
    private static $sDerivates = 'ubuntu|debian|mate|budgie';

    static public function execute()
    {
        if (! \preg_match('/'.self::$sDerivates.'/ui', \php_uname())) {
