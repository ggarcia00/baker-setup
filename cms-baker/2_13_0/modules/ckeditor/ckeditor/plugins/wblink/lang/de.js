...
CKEDITOR.plugins.setLang( 'wblink', 'de', {
    ...
    upload: 'Hochladen',
    toWb: 'WB-Link',
    selectPage: 'Bitte eine Seite wählen',
    wbPage: 'WB-Seiten',
    addon: 'Addon',
    addonItem: 'Detail Beiträge',
    selectAddon: 'Bitte einen Detail Beitrag wählen',
    noAddon: 'Keine Detail Beiträge gefunden'    
});
