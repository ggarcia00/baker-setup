...
//                            break;
...

            {
                ...
                html:'<div style="overflow:hidden;display:inline; min-width:450px; height:22px;">'+
                '<div id="droplet-info" style="overflow:hidden;min-width:450px; white-space:normal;">Here description...</div>'+
                '</div>'
            },
            {
                id:'infoUsage',
                ...
                label:'',widths:['100%'],
                style:'font-weight:normal;',
                html:'<div style="overflow:hidden;display:inline; min-width:450px; min-height:40px;">'+
                     '<div id="droplet-usage" style="overflow:hidden;min-width:450px; white-space:normal;">Here usage...</div>'+
                     '</div>'
            }
            ]
        }
