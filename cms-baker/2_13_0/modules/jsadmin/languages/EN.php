...
$MOD_JSADMIN['TXT_ERROR_INSTALLINFO_B']     = '<h1>Error</h1><p>JavaScript Admin requires the YUI (Yahoo User Interface) framework.<br />The following files are required for Javascript Admin to work as expected:<br /><br />';
