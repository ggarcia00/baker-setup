 ...
 * @version      4.0.0
 * @revision     $Id: EN.php 256 2019-03-17 19:30:13Z Luisehahne $
...
$MENU['REORG_TABLE'] = 'Reorganize tables';
...
$MESSAGE['ADMIN_INSUFFICIENT_PRIVELLIGES'] = 'Insufficient access privileges';
...
$MESSAGE['FRONTEND_SORRY_NO_VIEWING_PERMISSIONS'] = 'Sorry, you do not have permission to view this page';
...
$MESSAGE['GENERIC_NOT_UPGRADED'] = 'Update not possible';
...
$MESSAGE['GENERIC_SECURITY_OFFENSE'] = 'Security offense!! Data storage was refused!';
...
$MESSAGE['GENERIC_WEBSITE_NO_PAGES'] = 'This website has no pages for this language (%s) yet.';
...
$MESSAGE['LOGIN_AUTHENTICATION_FAILED'] = 'Login name or password incorrect';
...
$MESSAGE['LOGIN_USERNAME_BLANK'] = 'Please enter a login name';
$MESSAGE['LOGIN_USERNAME_TOO_LONG'] = 'Supplied login name too long';
$MESSAGE['LOGIN_USERNAME_TOO_SHORT'] = 'Supplied login name too short';
...
$MESSAGE['PAGES_INSUFFICIENT_PERMISSIONS'] = 'You do not have permission to modify this page';
...
$MESSAGE['SIGNUP2_NEW_USER'] = 'A new user has been registered';
...
$MESSAGE['UPLOAD_ERR_OK'] = 'File were successfully uploaded';
...
$MESSAGE['USERS_CHANGING_PASSWORD'] = 'Please note: You should only enter values in the above fields if you wish to change the password for this user';
...
$MESSAGE['USERS_DISPLAYNAME_TAKEN'] = 'The specified display name is already in use.';
...
$MESSAGE['USERS_NAME_INVALID_CHARS'] = 'Invalid chars for login name found';
...
$MESSAGE['USERS_USERNAME_TAKEN'] = 'The login name you entered is already taken';
$MESSAGE['USERS_USERNAME_TOO_SHORT'] = 'The login name you entered was too short';
...
$TEXT['BASIC'] = 'Basic';
$TEXT['BLOCK'] = 'Block';
$TEXT['BROWSE_UPLOAD_FILE'] = 'Select a file!';
...
$TEXT['INVALID_SIGNS'] = 'must begin with a letter or has invalid characters';
...
$TEXT['LOOP'] = 'Loop';
$TEXT['MAIN'] = 'Main';
$TEXT['USER_LOGIN_ON'] = 'Allow user login';
$TEXT['USER_LOGIN_OFF'] = 'Prevent user login';
...
$TEXT['RETYPE_NEW_PASSWORD'] = 'Retype New Password';
$TEXT['RETYPE_PASSWORD'] = 'Retype Password';
...
$TEXT['USERS_CAN_SELFDELETE'] = 'User can delete themselves';
$TEXT['USERS_CHANGE_SETTINGS'] = 'User can change their own settings';
...
$TEXT['WBMAILER_DEFAULT_SENDER_MAIL'] = 'Default "From" Address';
$TEXT['WBMAILER_DEFAULT_SENDER_NAME'] = 'Default Sender Name';
$TEXT['WBMAILER_DEFAULT_SETTINGS_NOTICE'] = 'Please specify a default "FROM" address and "SENDER" name below. It is recommended to use a FROM address like: <strong>admin@yourdomain.com</strong>. Some mail providers (e.g. <em>mail.com</em>) may reject mail with a FROM: address like <em>name@mail.com</em> sent via a foreign relay to avoid spam.<br /><br />The default values are only used if no other values are specified by WebsiteBaker. If your server supports <abbr title="Simple mail transfer protocol">SMTP</abbr>, you may want to use this option for outgoing mail.';
$TEXT['WBMAILER_FUNCTION'] = 'Mail Routine';
$TEXT['WBMAILER_NOTICE'] = '<strong>SMTP Mailer Settings:</strong><br />The settings below are only required if you want to send mail via <abbr title="Simple mail transfer protocol">SMTP</abbr>. If you do not know your SMTP host or you are not sure about the required settings, simply stay with the default mail routine: PHP MAIL.';
...
$TEXT['WEBSITE_DESCRIPTION'] = 'Metadata Description';
$TEXT['WEBSITE_FOOTER'] = 'Website Footer';
$TEXT['WEBSITE_HEADER'] = 'Website Header';
$TEXT['WEBSITE_KEYWORDS'] = 'Metadata Keywords';
$TEXT['WEBSITE_TITLE'] = 'Metadata Title';
$TEXT['WELCOME_BACK'] = 'Welcome back';
$TEXT['WIDTH'] = 'Width';
$TEXT['WINDOW'] = 'Window';
$TEXT['WINDOWS'] = 'Windows';
$TEXT['WORLD_WRITEABLE_FILE_PERMISSIONS'] = 'World-writable file permissions';
$TEXT['WRITE'] = 'Write';
$TEXT['WYSIWYG_EDITOR'] = 'WYSIWYG Editor';
$TEXT['WYSIWYG_STYLE'] = 'WYSIWYG Style';
$TEXT['YES'] = 'Yes';

$TEXT['NO_REVERT'] = 'You cannot undo this!';
$TEXT['NO_DELETED'] = 'Delete was not executed!';
