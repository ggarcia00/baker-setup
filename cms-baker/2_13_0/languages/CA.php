 ...
 * @version      4.0.0
 * @revision     $Id: CA.php 256 2019-03-17 19:30:13Z Luisehahne $
...
$TEXT['WBMAILER_DEFAULT_SETTINGS_NOTICE'] = 'Please specify a default "FROM" address and "SENDER" name below. It is recommended to use a FROM address like: <strong>admin@yourdomain.com</strong>. Some mail provider (e.g. <em>mail.com</em>) may reject mails with a FROM: address like <em>name@mail.com</em> sent via a foreign relay to avoid spam.<br /><br />The default values are only used if no other values are specified by WebsiteBaker. If your server supports <abbr title="Simple mail transfer protocol">SMTP</abbr>, you may want use this option for outgoing mails.';
