 ...
 * @version      4.0.0
 * @revision     $Id: FR.php 256 2019-03-17 19:30:13Z Luisehahne $
...
$TEXT['WBMAILER_DEFAULT_SETTINGS_NOTICE'] = 'Merci d\'indiquer un nom et une adresse d\'expéditeur par défaut. Il est recommandé d\'utiliser une adresse d\'expéditeur de la forme : <strong>admin@yourdomain.com</strong>. Certains opérateurs de mail (comme <em>mail.com</em>) peuvent rejeter les mails dont l\'adresse d\'expéditeur est de la forme <em>name@mail.com</em> envoyés via un relai, c\'est leur manière de lutter contre le spam.<br /><br />Les valeurs par défaut sont uniquement utilisées si aucune autre valeur n\'est spécifiée par WebsiteBaker. Si votre serveur supporte <abbr title="Simple mail transfer protocol">SMTP</abbr>, vous pouvez utiliser cette option pour l\'envoi d\'emails.';
